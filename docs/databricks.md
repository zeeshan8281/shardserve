...
Status: adapter implemented; **not executed on Databricks**. No workspace, region, compute shape or spending authorization has been supplied. Nothing in this repository provisions a cluster.
